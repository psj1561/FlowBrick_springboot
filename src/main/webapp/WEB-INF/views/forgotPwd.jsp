...
<head>
<meta charset="UTF-8">
<title>pms-forgotPassword</title>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#empno, #email").keyup(function(event) {
			if (event.keyCode === 13) {
				$("#forgotBtn").click();
			}
		});
							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										...
										<p class="mb-4">
											사원번호와 이메일 주소를 입력하시면,<br> 해당 이메일로 임시비밀번호를 보내드립니다.
										</p>
									</div>
									<form class="user" method="post" id="forgotFrm">
										...
										<button type="button"
											class="btn btn-primary btn-user btn-block" id=forgotBtn>비밀번호
											찾기</button>
									...
									<div class="text-center">
										<a class="small" href="${path}/login.do">로그인페이지로 이동</a> · <a
											class="small" href="${path}/forgotEmpno">사원번호 찾기</a>
									</div>
